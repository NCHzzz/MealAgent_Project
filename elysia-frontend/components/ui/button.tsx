  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 active:scale-95 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accept: "bg-accent/10 text-accent hover:bg-accent/20 border border-accent/30",
        outline:
          "border border-accent/30 shadow-sm hover:bg-accent/10 hover:text-accent hover:border-accent/50",
        secondary:
        ...
        primary:
          "bg-accent text-background hover:bg-accent/90 shadow-meal",
      },
      size: {
